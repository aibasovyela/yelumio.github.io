...
export const GlassCard = ({
  ...
  return (
    <div className={cn(
      ...
      "shadow-[0_4px_24px_hsl(0_0%_0%/0.5),inset_0_1px_0_hsl(var(--primary)/0.08)]",
      hover && "hover:border-primary/40 hover:shadow-[0_8px_32px_hsl(var(--primary)/0.2),inset_0_1px_0_hsl(var(--primary)/0.15)] hover:-translate-y-1",
      className
    )}>
      {/* Top shine line — gold */}
