              ...
              <Accordion type="single" collapsible className="space-y-3">
                {t.faq.items.map((faq, index) => (
                  <AccordionItem
                    key={index}
                    value={`faq-${index}`}
                    className="rounded-2xl px-6 border bg-card border-border shadow-sm text-foreground data-[state=open]:border-primary/40 data-[state=open]:shadow-[0_8px_32px_hsl(var(--primary)/0.15)] transition-all duration-300"
                  >
