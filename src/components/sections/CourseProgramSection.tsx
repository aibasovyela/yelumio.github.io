...
const modules = [{
  ...
  learn: ["Как рождаются идеи для креативов", "Где брать вдохновение и какие сайты использовать (реальные источники, а не \"ждать музу\")", "Как смотреть на визуал и понимать: это красиво или нет", "Почему один креатив работает, а другой нет", "Как из одной идеи делать несколько вариантов", "Как превращать идею в короткий сценарий под видео"],
  ...
  learn: ["Как работать с текстом в ИИ", "Как правильно писать промпты", "Какие текстовые нейросети лучшие и чем они отличаются", "Как нейросети воспринимают наши запросы", "Почему один и тот же запрос даёт разный результат", "Как формулировать запросы чётко, коротко и понятно", "Типичные ошибки в текстах и промптах"],
  ...
  learn: ["Как правильно монтировать короткие видео", "Структура ролика: начало, развитие, финал", "Как сделать, чтобы видео досматривали и сохраняли", "Правильные форматы под соцсети", "Какие программы лучше использовать для монтажа", "Типографика, обложки, безопасные зоны"],
  ...
  learn: ["Как оформить свою страницу или портфолио", "Какую презентацию подготовить", "Как показать свою работу заказчику", "Как оформлять кейсы", "Как презентовать результат", "Как использовать навык для заработка или своего бизнеса"],
...
const reviewScale = [{
  title: "Смысл",
  description: "Идея и сценарий"
}, {
  title: "Визуал",
  description: "Фото/композиция/свет"
}, {
  title: "Техничка",
  description: "Артефакты/движение/качество"
}, {
  title: "Упаковка",
  description: "Текст/субтитры/обложка"
}];
        ...
        <ScrollReveal>
          ...
          <Accordion type="single" collapsible className="space-y-4">
            {modules.map((module, index) => {
              ...
              return <AccordionItem key={index} value={`module-${index}`} className="glass-card-static bg-card text-card-foreground border-none px-6 data-[state=open]:shadow-glow">
                  <>
                        ...
                        <div className="flex items-start gap-3">
                          ...
                          <div>
                            ...
                            <ul className="space-y-1.5">
                              {module.learn.map((item, i) => <li key={i} className="text-sm flex items-start gap-2">
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <ul className="space-y-1">
                                {module.homework.map((item, i) => <li key={i} className="text-sm flex items-start gap-2">
          ...
          <div className="max-w-4xl mx-auto mt-16">
            <GlassCard className="p-8 md:p-10 bg-primary/5 border-primary/20">
              <div className="text-center mb-8">
                ...
                <p className="text-lg text-muted-foreground max-w-2xl mx-auto">Вы получаете конкретные правки: что исправить, почему, и как сделать лучше.</p>
              </div>

              {/* Review Scale */}
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {reviewScale.map((item, index) => <div key={index} className="text-center p-4 rounded-xl bg-background/50 border border-border/50">
