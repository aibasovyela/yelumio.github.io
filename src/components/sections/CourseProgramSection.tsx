...
const modules = [
  {
    ...
    homework: "Написать 3 хука + 3 сценария (очень коротко), выбрать 1 сценарий и сделать шот-лист (3–6 кадров)",
  ...
  },
  {
    ...
    homework: "Сгенерировать 3 фото + приложить промпты, сделать 2 вариации света (например softbox vs rim)",
  ...
  },
  {
    ...
    icon: Video,
    learn: [
      "Типы генерации: image→video и text→video (объяснить через задачи)",
    ...
    homework: "Оживить 1 кадр в 2 стилях движения (slow cinematic + energetic), собрать мини-сцену 2–3 клипа по 3–5 секунд",
    check: "Логичность движения камеры, естественность, отсутствие артефактов и \"ломаного\" лица/логотипа",
  },
  {
    number: "04",
    ...
    homework: "Подобрать/сгенерировать 2 музыкальные дорожки или варианты, добавить 3–5 звуковых акцентов (SFX)",
  ...
  },
  {
    ...
    homework: "Кейс: сценарий + 3 фото + 2–3 видео + звук/речь + итоговый ролик + краткое описание",
    check: "Связность кейса, качество результата, умение объяснить \"почему так\", готовность показывать клиенту",
  },
];
