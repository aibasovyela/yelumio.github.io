...
export const HeroSection = () => {
  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center overflow-hidden <section className="relative min-h-screen flex items-center overflow-hidden bg-[hsl(48_80%_35%)] text-[hsl(240_6%_7%)]"> text-[hsl(240_6%_7%)]">
