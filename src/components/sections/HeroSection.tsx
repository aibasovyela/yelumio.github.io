...
export const HeroSection = () => {
  ...
  return (
    <>
      <section className="relative min-h-screen flex items-center overflow-hidden <section className="relative min-h-screen flex items-center overflow-hidden bg-[hsl(40_50%_88%)] text-[hsl(240_6%_7%)]"> text-[hsl(240_6%_7%)]">
